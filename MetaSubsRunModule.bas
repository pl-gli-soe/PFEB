...
Public Sub ms9pv400_SEC_STD_PACK(mh As MgoHandler, col As Integer, item As InputitemHandler, osh As Worksheet)
    If UCase(mh.m_mgo.this_screen) = mh.m_ms9pv400.NAME Then
        ' body of this subroutine
        refresh_ms9pv400 mh, item
        osh.Cells(Int(item.iih_id), col) = mh.m_ms9pv400.SEC_STD_PACK()
    Else
        mh.m_ms9pv400.open_this_screen
        ms9pv400_SEC_STD_PACK mh, col, item, osh
    End If
End Sub


Public Sub ms9pv400_SEC_CNTR(mh As MgoHandler, col As Integer, item As InputitemHandler, osh As Worksheet)
    If UCase(mh.m_mgo.this_screen) = mh.m_ms9pv400.NAME Then
        ' body of this subroutine
        refresh_ms9pv400 mh, item
        osh.Cells(Int(item.iih_id), col) = mh.m_ms9pv400.SEC_CNTR()
    Else
        mh.m_ms9pv400.open_this_screen
        ms9pv400_SEC_CNTR mh, col, item, osh
    End If
End Sub

Public Sub ms9pv400_SEC_CONT_WG(mh As MgoHandler, col As Integer, item As InputitemHandler, osh As Worksheet)
    If UCase(mh.m_mgo.this_screen) = mh.m_ms9pv400.NAME Then
        ' body of this subroutine
        refresh_ms9pv400 mh, item
        osh.Cells(Int(item.iih_id), col) = mh.m_ms9pv400.SEC_CONT_WG()
    Else
        mh.m_ms9pv400.open_this_screen
        ms9pv400_SEC_CONT_WG mh, col, item, osh
    End If
End Sub
Public Sub ms9pv400_SEC_DIM(mh As MgoHandler, col As Integer, item As InputitemHandler, osh As Worksheet)
    If UCase(mh.m_mgo.this_screen) = mh.m_ms9pv400.NAME Then
        ' body of this subroutine
        refresh_ms9pv400 mh, item
        osh.Cells(Int(item.iih_id), col) = mh.m_ms9pv400.SEC_DIM()
    Else
        mh.m_ms9pv400.open_this_screen
        ms9pv400_SEC_DIM mh, col, item, osh
    End If
End Sub

Public Sub ms9pv400_PRIM_DIM(mh As MgoHandler, col As Integer, item As InputitemHandler, osh As Worksheet)
    If UCase(mh.m_mgo.this_screen) = mh.m_ms9pv400.NAME Then
        ' body of this subroutine
        refresh_ms9pv400 mh, item
        osh.Cells(Int(item.iih_id), col) = mh.m_ms9pv400.PRIM_DIM()
    Else
        mh.m_ms9pv400.open_this_screen
        ms9pv400_PRIM_DIM mh, col, item, osh
    End If
End Sub
' =========================================================================================================
