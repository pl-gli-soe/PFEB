...
Public Sub delete_this_sheet(ictrl As IRibbonControl)
    ...
    If (ActiveSheet.NAME Like "*preinput*") Or _
        ...
        (ActiveSheet.NAME Like "*config*") Or _
        (ActiveSheet.NAME Like "*OSEA_CC*") Or _
        (ActiveSheet.NAME Like "*VLOOKUP*") Then
    ...
    If ret = vbYes Then
        ...
        Do
            If (Sheets(x).NAME Like "*preinput*") Or _
                ...
                (Sheets(x).NAME Like "*config*") Or _
                (Sheets(x).NAME Like "*OSEA_CC*") Or _
                (Sheets(x).NAME Like "*VLOOKUP*") Then
                x = x + 1
            Else
                Sheets(x).Delete
            End If
